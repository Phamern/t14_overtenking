    ...
    */
    ...
    function create_if_block_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img.src !== (img_src_value = /*polaroid*/ ctx[8][1])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "polaroid");
    			attr_dev(img, "class", "polaroid1 svelte-1bm5n99");
    			add_location(img, file$1, 82, 4, 2653);
    			attr_dev(section, "class", "fixed svelte-1bm5n99");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img7, "class", "plant svelte-1bm5n99");
    			...
    			attr_dev(img8, "class", "table svelte-1bm5n99");
    			...
    			attr_dev(img9, "class", "pillow svelte-1bm5n99");
    			...
    			attr_dev(img10, "class", "sofa svelte-1bm5n99");
    			...
    			attr_dev(section, "class", "svelte-1bm5n99");
    			add_location(section, file$1, 45, 2, 1226);
    			attr_dev(main, "class", "svelte-1bm5n99");
    			...
    			attr_dev(img11, "class", "door-icon svelte-1bm5n99");
    ...
    function create_if_block_2$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img.src !== (img_src_value = /*polaroid*/ ctx[8][0])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "polaroid");
    			attr_dev(img, "class", "polaroid1 svelte-ycznsq");
    			add_location(img, file$2, 81, 4, 2606);
    			attr_dev(section, "class", "fixed svelte-ycznsq");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			img11 = element("img");
    			if (img0.src !== (img0_src_value = /*backImage*/ ctx[6])) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "class", "backImage svelte-ycznsq");
    			attr_dev(img0, "alt", "Background");
    			add_location(img0, file$2, 45, 3, 1125);
    			if (img1.src !== (img1_src_value = /*images*/ ctx[7][0])) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "parallax");
    			attr_dev(img1, "class", "room svelte-ycznsq");
    			...
    			attr_dev(img2, "alt", "parallax");
    			attr_dev(img2, "class", "carpet svelte-ycznsq");
    			...
    			attr_dev(img3, "alt", "parallax");
    			attr_dev(img3, "class", "sacco svelte-ycznsq");
    			...
    			attr_dev(img4, "alt", "parallax");
    			attr_dev(img4, "class", "cat svelte-ycznsq");
    			...
    			attr_dev(img5, "alt", "parallax");
    			attr_dev(img5, "class", "pillow svelte-ycznsq");
    			...
    			attr_dev(img6, "alt", "parallax");
    			attr_dev(img6, "class", "bottle svelte-ycznsq");
    			...
    			attr_dev(img10, "alt", "parallax");
    			attr_dev(img10, "class", "books svelte-ycznsq");
    			...
    			attr_dev(section, "class", "svelte-ycznsq");
    			add_location(section, file$2, 44, 2, 1112);
    			attr_dev(main, "class", "svelte-ycznsq");
    			add_location(main, file$2, 43, 0, 1102);
    			if (img11.src !== (img11_src_value = /*doorIcon*/ ctx[5])) attr_dev(img11, "src", img11_src_value);
    			attr_dev(img11, "alt", "doorIcon");
    			attr_dev(img11, "class", "door-icon svelte-ycznsq");
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", img_class_value = "doors" + /*myNumber*/ ctx[0] + " svelte-1itvcza");
    			add_location(img, file$3, 30, 10, 621);
    			attr_dev(div, "class", "clickable svelte-1itvcza");
    			add_location(div, file$3, 29, 6, 569);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*myNumber*/ 1 && img_class_value !== (img_class_value = "doors" + /*myNumber*/ ctx[0] + " svelte-1itvcza")) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 19, 5, 279);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			if_block.c();
    			add_location(main, file$3, 17, 0, 254);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(20:4) {#each doors as door, i}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link0, file$4, 12, 2, 206);
    			attr_dev(link1, "href", "https://fonts.googleapis.com/css?family=Caveat&display=swap");
    			attr_dev(link1, "rel", "stylesheet");
    			add_location(link1, file$4, 13, 2, 307);
    			attr_dev(h1, "class", "svelte-1oinwjt");
    			add_location(h1, file$4, 17, 2, 423);
    			attr_dev(section, "class", "doors svelte-1oinwjt");
    			add_location(section, file$4, 18, 2, 446);
    			attr_dev(main, "class", "svelte-1oinwjt");
    			add_location(main, file$4, 16, 0, 414);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			t = text(/*status*/ ctx[0]);
    			attr_dev(h1, "class", "svelte-f91bkd");
    			add_location(h1, file$5, 14, 2, 287);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			audio.autoplay = true;
    			audio.loop = true;
    			add_location(audio, file$5, 12, 1, 225);
    			add_location(main, file$5, 10, 0, 206);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
